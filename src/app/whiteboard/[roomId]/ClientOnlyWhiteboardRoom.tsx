...
export default function ClientOnlyWhiteboardRoom({ roomId }: { roomId: string }) {
  ...
  if (!checkedToken) {
    return (
      <div className="flex flex-col h-screen w-full bg-gray-100 items-center justify-center">
